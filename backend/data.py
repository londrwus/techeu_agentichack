...
# The built React front-end (web/ -> `npm run build` -> frontend_react/): the dashboard and the landing page.
FRONTEND = Path(os.environ.get("ORBIT_FRONTEND") or ROOT / "frontend_react").resolve()
